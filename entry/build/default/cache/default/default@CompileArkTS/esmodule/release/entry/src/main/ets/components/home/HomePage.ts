...
export class HomePage extends ViewPU {
    ...
    initialRender() {
        ...
        }, Column);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new WeatherCard(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/components/home/HomePage.ets", line: 176, col: 11 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.isDataStatExpanded) {
                this.ifElseBranchUpdateFunction(0, () => {
                    ...
                    this.StatItem.bind(this)('设备总数', `${this.controlDevices.length}`, AppColors.PRIMARY_COLOR);
        ...
        '%', // 单位
        AppColors.PRIMARY_COLOR, 30, // 最低阈值
        80, // 最高阈值
        '湿度正常' // 正常状态文本
        );
