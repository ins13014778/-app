import { ColumnInfo } from "@normalized:N&&&entry/src/main/ets/formcommon/utils/dbutils/RdbUtils&";
/**
...
export class FormDbInfo {
     ...
     */
    constructor(formName: string, tableName: string, variableList: Map<string, string>, insertData?: Array<Map<string, string>>) {
