...
function insert(dbStore: dataRdb.RdbStore, tableName: string, values: dataRdb.ValuesBucket | Array<dataRdb.ValuesBucket>): Promise<number> {
...
function saveData(dbStore: dataRdb.RdbStore, tableName: string, values: Array<dataRdb.ValuesBucket>, index: number, callback: Function): void {
