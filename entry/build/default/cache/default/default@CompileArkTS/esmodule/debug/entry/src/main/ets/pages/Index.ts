...
interface Index_Params {
    ...
    monitorWebController?: webview.WebviewController;
    cozeBearerToken?: string;
    cozeTokenInput?: string;
    showCozeTokenDialog?: boolean;
    isCozeRunLoading?: boolean;
    cozeRunResultText?: string;
    cozeRunResultScroller?: Scroller;
    COZE_TOKEN_STORAGE_KEY?: string;
...
class Index extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__monitorStreamUrl = new ObservedPropertySimplePU('http://esp32.zy991.cn/stream', this, "monitorStreamUrl");
        this.monitorWebController = new webview.WebviewController();
        this.__cozeBearerToken = new ObservedPropertySimplePU('', this, "cozeBearerToken");
        this.__cozeTokenInput = new ObservedPropertySimplePU('', this, "cozeTokenInput");
        this.__showCozeTokenDialog = new ObservedPropertySimplePU(false, this, "showCozeTokenDialog");
        this.__isCozeRunLoading = new ObservedPropertySimplePU(false, this, "isCozeRunLoading");
        this.__cozeRunResultText = new ObservedPropertySimplePU('', this, "cozeRunResultText");
        this.cozeRunResultScroller = new Scroller();
        this.COZE_TOKEN_STORAGE_KEY = 'coze_bearer_token';
    ...
    setInitiallyProvidedValue(params: Index_Params) {
        ...
        if (params.monitorStreamUrl !== undefined) {
            this.monitorStreamUrl = params.monitorStreamUrl;
        }
        if (params.monitorWebController !== undefined) {
            this.monitorWebController = params.monitorWebController;
        }
        if (params.cozeBearerToken !== undefined) {
            this.cozeBearerToken = params.cozeBearerToken;
        }
        if (params.cozeTokenInput !== undefined) {
            this.cozeTokenInput = params.cozeTokenInput;
        }
        if (params.showCozeTokenDialog !== undefined) {
            this.showCozeTokenDialog = params.showCozeTokenDialog;
        }
        if (params.isCozeRunLoading !== undefined) {
            this.isCozeRunLoading = params.isCozeRunLoading;
        }
        if (params.cozeRunResultText !== undefined) {
            this.cozeRunResultText = params.cozeRunResultText;
        }
        if (params.cozeRunResultScroller !== undefined) {
            this.cozeRunResultScroller = params.cozeRunResultScroller;
        }
        if (params.COZE_TOKEN_STORAGE_KEY !== undefined) {
            this.COZE_TOKEN_STORAGE_KEY = params.COZE_TOKEN_STORAGE_KEY;
        }
    ...
    purgeVariableDependenciesOnElmtId(rmElmtId) {
        ...
        this.__monitorStreamUrl.purgeDependencyOnElmtId(rmElmtId);
        this.__cozeBearerToken.purgeDependencyOnElmtId(rmElmtId);
        this.__cozeTokenInput.purgeDependencyOnElmtId(rmElmtId);
        this.__showCozeTokenDialog.purgeDependencyOnElmtId(rmElmtId);
        this.__isCozeRunLoading.purgeDependencyOnElmtId(rmElmtId);
        this.__cozeRunResultText.purgeDependencyOnElmtId(rmElmtId);
    ...
    aboutToBeDeleted() {
        ...
        this.__monitorStreamUrl.aboutToBeDeleted();
        this.__cozeBearerToken.aboutToBeDeleted();
        this.__cozeTokenInput.aboutToBeDeleted();
        this.__showCozeTokenDialog.aboutToBeDeleted();
        this.__isCozeRunLoading.aboutToBeDeleted();
        this.__cozeRunResultText.aboutToBeDeleted();
    ...
    // ========== 用户认证状态 ==========
    // 管理用户的登录状态和相关信息
    private __currentIndex: ObservedPropertySimplePU<number>; // 当前选中的Tab索引（0=首页，1=控制，2=监控，3=分析，4=我的）
    get currentIndex() {
    ...
    private __monitorStreamUrl: ObservedPropertySimplePU<string>;
    get monitorStreamUrl() {
        return this.__monitorStreamUrl.get();
    }
    set monitorStreamUrl(newValue: string) {
        this.__monitorStreamUrl.set(newValue);
    }
    private monitorWebController: webview.WebviewController;
    private __cozeBearerToken: ObservedPropertySimplePU<string>;
    get cozeBearerToken() {
        return this.__cozeBearerToken.get();
    }
    set cozeBearerToken(newValue: string) {
        this.__cozeBearerToken.set(newValue);
    }
    private __cozeTokenInput: ObservedPropertySimplePU<string>;
    get cozeTokenInput() {
        return this.__cozeTokenInput.get();
    }
    set cozeTokenInput(newValue: string) {
        this.__cozeTokenInput.set(newValue);
    }
    private __showCozeTokenDialog: ObservedPropertySimplePU<boolean>;
    get showCozeTokenDialog() {
        return this.__showCozeTokenDialog.get();
    }
    set showCozeTokenDialog(newValue: boolean) {
        this.__showCozeTokenDialog.set(newValue);
    }
    private __isCozeRunLoading: ObservedPropertySimplePU<boolean>;
    get isCozeRunLoading() {
        return this.__isCozeRunLoading.get();
    }
    set isCozeRunLoading(newValue: boolean) {
        this.__isCozeRunLoading.set(newValue);
    }
    private __cozeRunResultText: ObservedPropertySimplePU<string>;
    get cozeRunResultText() {
        return this.__cozeRunResultText.get();
    }
    set cozeRunResultText(newValue: string) {
        this.__cozeRunResultText.set(newValue);
    }
    private cozeRunResultScroller: Scroller;
    private readonly COZE_TOKEN_STORAGE_KEY: string;
    // ========== 用户菜单 ==========
    // 个人中心的菜单项配置
    ...
    initialRender() {
                            ...
                            this.ifElseBranchUpdateFunction(0, () => {
                                {
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        if (isInitialRender) {
                                            ...
                                            }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Index.ets", line: 281, col: 11 });
                            ...
                            this.ifElseBranchUpdateFunction(1, () => {
                                {
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        if (isInitialRender) {
                                            ...
                                            }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Index.ets", line: 292, col: 11 });
                                            ViewPU.create(componentCall);
                                            let paramsLambda = () => {
                                                return {
                                                    username: this.username,
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                        ...
                        TabContent.create(() => {
                            {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    if (isInitialRender) {
                                        ...
                                        }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Index.ets", line: 311, col: 13 });
                                        ViewPU.create(componentCall);
                                        let paramsLambda = () => {
                                            return {
                        ...
                        TabContent.create(() => {
                            {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    if (isInitialRender) {
                                        ...
                                        }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Index.ets", line: 333, col: 13 });
                                        ViewPU.create(componentCall);
                                        let paramsLambda = () => {
                                            return {
                                                controlDevices: this.controlDevices,
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        TabContent.create(() => {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Image.create({ "id": 0, "type": 30000, params: ['在线.png'], "bundleName": "com.example.myapplication", "moduleName": "entry" });
                                Image.width(20);
                                Image.height(20);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Image.create({ "id": 0, "type": 30000, params: ['刷新.png'], "bundleName": "com.example.myapplication", "moduleName": "entry" });
                                Image.width(18);
                                Image.height(18);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Image.create({ "id": 0, "type": 30000, params: ['预警提醒.png'], "bundleName": "com.example.myapplication", "moduleName": "entry" });
                                Image.width(18);
                                Image.height(18);
                                Image.fillColor('#FFFFFF');
                            }, Image);
                            ...
                            Row.pop();
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Web.create({ src: this.monitorStreamUrl, controller: this.monitorWebController });
                                Web.width('100%');
                                Web.height(240);
                                Web.backgroundColor('#000000');
                            }, Web);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.width('100%');
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Button.createWithLabel('智能分析');
                                Button.width('44%');
                                Button.height(44);
                                Button.fontSize(16);
                                Button.fontColor('#FFFFFF');
                                Button.backgroundColor(this.isCozeRunLoading ? '#CCCCCC' : AppColors.PRIMARY_COLOR);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                if (this.cozeRunResultText) {
                                    this.ifElseBranchUpdateFunction(0, () => {
                                        ...
                                        Text.pop();
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            Scroll.create(this.cozeRunResultScroller);
                                            Scroll.height(220);
                                            Scroll.scrollBar(BarState.Auto);
                                        }, Scroll);
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            Text.create(this.cozeRunResultText);
                                            Text.fontSize(12);
                        ...
                        TabContent.tabBar({ builder: () => {
                                this.TabBuilder.call(this, '监控', 2);
                            } });
                    }, TabContent);
                    TabContent.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        TabContent.create(() => {
                            {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    if (isInitialRender) {
                                        ...
                                        }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Index.ets", line: 476, col: 11 });
                                        ViewPU.create(componentCall);
                                        let paramsLambda = () => {
                                            return {
                                                temperature: this.temperature,
                        ...
                        TabContent.tabBar({ builder: () => {
                                this.TabBuilder.call(this, '分析', 3);
                            } });
                    }, TabContent);
                    TabContent.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        TabContent.create(() => {
                            {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    if (isInitialRender) {
                                        ...
                                        }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Index.ets", line: 497, col: 13 });
                                        ViewPU.create(componentCall);
                                        let paramsLambda = () => {
                                            return {
                        ...
                        TabContent.tabBar({ builder: () => {
                                this.TabBuilder.call(this, '我的', 4);
                            } });
                    }, TabContent);
                    TabContent.pop();
                    // ========== 已登录或游客模式 ==========
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.showCozeTokenDialog) {
                this.ifElseBranchUpdateFunction(0, () => {
                    ...
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        TextArea.create({ placeholder: '请输入 Bearer Token（不含 Bearer 前缀）', text: this.cozeTokenInput });
                        TextArea.width('100%');
                        TextArea.height(120);
        ...
        If.pop();
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new EditDeviceNameDialog(this, {
                    ...
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Index.ets", line: 584, col: 7 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.create(index === 0 ? { "id": 0, "type": 30000, params: ['首页.png'], "bundleName": "com.example.myapplication", "moduleName": "entry" } :
                            index === 1 ? { "id": 0, "type": 30000, params: ['控制.png'], "bundleName": "com.example.myapplication", "moduleName": "entry" } :
                                index === 2 ? { "id": 0, "type": 30000, params: ['在线.png'], "bundleName": "com.example.myapplication", "moduleName": "entry" } :
                                    index === 3 ? { "id": 0, "type": 30000, params: ['分析.png'], "bundleName": "com.example.myapplication", "moduleName": "entry" } : { "id": 0, "type": 30000, params: ['我的.png'], "bundleName": "com.example.myapplication", "moduleName": "entry" });
                        // 选中状态：图标更大，颜色更亮
                        Image.width(28);
                        // 选中状态：图标更大，颜色更亮
                        Image.height(28);
    ...
    async loadCozeBearerToken() {
        try {
            const pref = await preferences.getPreferences(this.getUIContext().getHostContext() as common.UIAbilityContext, 'app_config');
            const savedToken: string = await pref.get(this.COZE_TOKEN_STORAGE_KEY, '') as string;
            if (savedToken)
                this.cozeBearerToken = savedToken;
        }
        catch (_) { }
    }
    ...
    formatCozeRunResult(raw: string): string {
        try {
            ...
            if (analysis) {
                const lines: string[] = [];
                if (analysis.leaf_type)
                    lines.push(`叶型：${analysis.leaf_type}`);
                if (analysis.health_status)
                    lines.push(`健康状态：${analysis.health_status}`);
                if (typeof analysis.confidence === 'number')
                    lines.push(`置信度：${analysis.confidence}`);
                const diagnosis = analysis.diagnosis;
                if (diagnosis) {
                    const diagLines: string[] = [];
                    if (diagnosis.color_analysis)
                        diagLines.push(`- 颜色：${diagnosis.color_analysis}`);
                    if (diagnosis.spot_detection)
                        diagLines.push(`- 斑点：${diagnosis.spot_detection}`);
                    if (diagnosis.wilt_analysis)
                        diagLines.push(`- 萎蔫：${diagnosis.wilt_analysis}`);
                    if (diagnosis.pest_detection)
                        diagLines.push(`- 虫害：${diagnosis.pest_detection}`);
                    if (diagnosis.disease_detection)
                        diagLines.push(`- 病害：${diagnosis.disease_detection}`);
