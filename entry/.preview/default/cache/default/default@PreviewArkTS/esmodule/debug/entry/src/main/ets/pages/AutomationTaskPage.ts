...
class AutomationTaskPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(98:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(100:7)", "entry");
            Scroll.layoutWeight(1);
            Scroll.backgroundColor('#F5F7F9');
        }, Scroll);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(101:9)", "entry");
            Column.width('100%');
    ...
    private buildTopBar(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(123:5)", "entry");
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(124:7)", "entry");
            Row.width('100%');
            Row.height(56);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(125:9)", "entry");
            Row.width(44);
            Row.height(44);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('←');
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(126:11)", "entry");
            Text.fontSize(26);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('新建自动化任务');
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(137:9)", "entry");
            Text.fontSize(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(142:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('👁️');
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(144:9)", "entry");
            Text.fontSize(20);
            Text.fontColor('#FFFFFF');
            Text.opacity(0.85);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(153:7)", "entry");
            Column.width('100%');
            Column.height(12);
        }, Column);
        Column.pop();
    ...
    private buildToggleCard(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(165:5)", "entry");
            Column.width('90%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(166:7)", "entry");
            Row.width('100%');
            Row.padding({ top: 16, bottom: 16 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('开启任务');
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(167:9)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(172:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Toggle.create({ type: ToggleType.Switch, isOn: this.enableTask });
            Toggle.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(174:9)", "entry");
    ...
    private buildScheduleCard(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(193:5)", "entry");
            Column.width('90%');
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
            Column.margin({ top: 16 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(194:7)", "entry");
            Row.width('100%');
            Row.padding({ left: 20, right: 20, top: 16 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('定时');
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(195:9)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor('#333333');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(200:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Toggle.create({ type: ToggleType.Switch, isOn: this.enableSchedule });
            Toggle.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(202:9)", "entry");
            Toggle.selectedColor('#11C26D');
            Toggle.switchPointColor('#FFFFFF');
            Toggle.onChange((isOn: boolean) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('重复');
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(212:7)", "entry");
            Text.fontSize(13);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 8 });
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(218:7)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(220:11)", "entry");
                    Column.width(28);
                    Column.height(28);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(221:13)", "entry");
                    Text.fontSize(13);
                    Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Divider.create();
            Divider.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(239:7)", "entry");
            Divider.color('#F0F0F0');
            Divider.width('100%');
        }, Divider);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(241:7)", "entry");
            Row.width('100%');
            Row.padding({ left: 20, right: 20, top: 16, bottom: 16 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('时间');
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(242:9)", "entry");
            Text.fontSize(14);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(246:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.selectedTime);
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(248:9)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
    ...
    private buildConditionCard(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(264:5)", "entry");
            Column.width('90%');
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
            Column.margin({ top: 16 });
    ...
    private buildActionCard(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(285:5)", "entry");
            Column.width('90%');
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
            Column.margin({ top: 16 });
    ...
    private buildAdvancedCard(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(306:5)", "entry");
            Column.width('90%');
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(307:7)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('高级选项');
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(308:9)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor('#11C26D');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(313:9)", "entry");
        }, Blank);
        Blank.pop();
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(319:7)", "entry");
            Row.width('100%');
            Row.padding({ left: 20, right: 20, top: 16, bottom: 16 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(320:9)", "entry");
            Column.layoutWeight(1);
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('延时执行');
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(321:11)", "entry");
            Text.fontSize(14);
            Text.fontColor('#666666');
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(325:11)", "entry");
            Text.fontSize(12);
            Text.fontColor('#8A8F99');
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(332:9)", "entry");
            Row.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(333:11)", "entry");
            Text.fontSize(14);
            Text.fontColor('#11C26D');
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Divider.create();
            Divider.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(344:7)", "entry");
            Divider.color('#F0F0F0');
            Divider.width('100%');
        }, Divider);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(346:7)", "entry");
            Row.width('100%');
            Row.padding({ left: 20, right: 20, top: 16, bottom: 16 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(347:9)", "entry");
            Column.layoutWeight(1);
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('仅执行一次');
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(348:11)", "entry");
            Text.fontSize(14);
            Text.fontColor('#666666');
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(352:11)", "entry");
            Text.fontSize(12);
            Text.fontColor('#8A8F99');
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Toggle.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(359:9)", "entry");
            Toggle.selectedColor('#11C26D');
            Toggle.switchPointColor('#FFFFFF');
            Toggle.onChange((isOn: boolean) => {
    ...
    private buildBottomButtons(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 16 });
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(377:5)", "entry");
            Row.width('90%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(378:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(389:7)", "entry");
            Button.layoutWeight(1);
            Button.height(48);
            Button.fontSize(16);
            Button.fontColor('#FFFFFF');
    ...
    private buildSectionHeader(title: string, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(410:5)", "entry");
            Row.width('100%');
            Row.padding({ left: 20, right: 20, top: 18, bottom: 8 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(title);
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(411:7)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor('#333333');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(416:7)", "entry");
        }, Blank);
        Blank.pop();
        Row.pop();
    }
    private buildItemRow(iconText: string, description: string, location: string, onTap: () => void, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(424:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(425:7)", "entry");
            Row.width('100%');
            Row.padding({ left: 20, right: 20, top: 16, bottom: 16 });
            Row.onClick(() => {
                onTap();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(426:9)", "entry");
            Text.fontSize(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(430:9)", "entry");
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(description);
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(431:11)", "entry");
            Text.fontSize(14);
            Text.fontColor('#333333');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(436:11)", "entry");
            Text.fontSize(12);
            Text.fontColor('#8A8F99');
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(442:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('➔');
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(444:9)", "entry");
            Text.fontSize(14);
    ...
    private buildAddRow(onTap: () => void, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(458:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(459:7)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('+ 添加');
            Text.debugLine("entry/src/main/ets/pages/AutomationTaskPage.ets(460:9)", "entry");
            Text.fontSize(14);
            Text.fontColor('#11C26D');
