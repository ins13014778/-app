...
class Index extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/Index.ets(231:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.userMode === 'not_logged_in') {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Tabs.debugLine("entry/src/main/ets/pages/Index.ets(263:9)", "entry");
                        // ========== 已登录或游客模式 ==========
                        // 已登录或游客模式：显示主应用界面（底部Tab导航）
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        TabContent.debugLine("entry/src/main/ets/pages/Index.ets(265:11)", "entry");
                    }, TabContent);
                    TabContent.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        TabContent.create(() => {
                        ...
                        TabContent.debugLine("entry/src/main/ets/pages/Index.ets(287:11)", "entry");
                    }, TabContent);
                    TabContent.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        TabContent.create(() => {
                        ...
                        TabContent.debugLine("entry/src/main/ets/pages/Index.ets(313:11)", "entry");
                    }, TabContent);
                    TabContent.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        TabContent.create(() => {
                        ...
                        TabContent.debugLine("entry/src/main/ets/pages/Index.ets(334:11)", "entry");
                    }, TabContent);
                    TabContent.pop();
                    // ========== 已登录或游客模式 ==========
                    // 已登录或游客模式：显示主应用界面（底部Tab导航）
    ...
    TabBuilder(title: string, index: number, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Index.ets(373:5)", "entry");
            Column.width('100%');
            ...
            if (this.currentIndex === index) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/pages/Index.ets(377:9)", "entry");
                        // 选中状态：图标更大，颜色更亮
                        Image.width(28);
                        // 选中状态：图标更大，颜色更亮
                        Image.height(28);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.create(index === 0 ? { "id": 0, "type": 30000, params: ['首页.png'], "bundleName": "com.example.myapplication", "moduleName": "entry" } :
                            index === 1 ? { "id": 0, "type": 30000, params: ['控制.png'], "bundleName": "com.example.myapplication", "moduleName": "entry" } :
                                index === 2 ? { "id": 0, "type": 30000, params: ['分析.png'], "bundleName": "com.example.myapplication", "moduleName": "entry" } : { "id": 0, "type": 30000, params: ['我的.png'], "bundleName": "com.example.myapplication", "moduleName": "entry" });
                        Image.debugLine("entry/src/main/ets/pages/Index.ets(385:9)", "entry");
                        // 未选中状态：图标较小，颜色较暗
                        Image.width(24);
                        // 未选中状态：图标较小，颜色较暗
                        Image.height(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            // Tab标题 - 根据当前选中状态显示不同样式
            Text.fontColor(this.currentIndex === index ? '#00C853' : '#999999');
            // Tab标题 - 根据当前选中状态显示不同样式
    ...
    handleMenuItemClick(itemId: string) {
        ...
        if (itemId === 'settings') {
            router.pushUrl({
                ...
                console.error('[Index] 打开设置页面失败:', error);
            });
            return;
        }
        if (itemId === 'logout')
