...
export class AnalysisPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/analysis/AnalysisPage.ets(31:5)", "entry");
            Column.width('100%');
            Column.height('100%');
            Column.linearGradient({
                angle: 180,
                colors: [[0xE8F5E9, 0.0], [0xC8E6C9, 0.5], [0xA5D6A7, 1.0]]
            });
        }, Column);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/components/analysis/AnalysisPage.ets", line: 33, col: 7 });
