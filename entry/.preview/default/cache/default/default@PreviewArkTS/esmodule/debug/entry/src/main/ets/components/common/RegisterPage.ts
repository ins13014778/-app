...
export class RegisterPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(20:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 顶部返回按钮
            Row.create();
            Row.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(22:7)", "entry");
            // 顶部返回按钮
            Row.width('100%');
            // 顶部返回按钮
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(23:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(24:11)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('←');
            Text.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(25:13)", "entry");
            Text.fontSize(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('返回登录');
            Text.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(29:13)", "entry");
            Text.fontSize(16);
            Text.fontColor('#4facfe');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(40:9)", "entry");
        }, Blank);
        Blank.pop();
        // 顶部返回按钮
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 顶部标题区域
            Column.create();
            Column.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(46:7)", "entry");
            // 顶部标题区域
            Column.width('100%');
            // 顶部标题区域
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(47:9)", "entry");
            Image.width(60);
            Image.height(60);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('创建账户');
            Text.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(53:9)", "entry");
            Text.fontSize(30);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(59:9)", "entry");
            Text.fontSize(15);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 注册表单区域
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(69:7)", "entry");
            // 注册表单区域
            Scroll.layoutWeight(1);
        }, Scroll);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(70:9)", "entry");
            Column.width('100%');
            ...
            if (this.errorMessage) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(98:13)", "entry");
                        Text.fontSize(14);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.successMessage) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(106:13)", "entry");
                        Column.width('100%');
                        Column.margin({ bottom: 20 });
                    }, Column);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create(this.successMessage);
                        Text.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(107:15)", "entry");
                        Text.fontSize(14);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(113:15)", "entry");
                        // 返回登录按钮
                        Button.width('100%');
                        // 返回登录按钮
                        Button.height(48);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (!this.successMessage) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Stack.create();
                        Stack.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(130:13)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        if (!this.isLoading) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Column.create();
                                    Column.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(132:17)", "entry");
                                    Column.width('100%');
                                    Column.height(54);
                            ...
                            this.ifElseBranchUpdateFunction(1, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Column.create();
                                    Column.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(147:17)", "entry");
                                    Column.width('100%');
                                    Column.height(54);
                                    Column.borderRadius(27);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(154:15)", "entry");
                        Button.width('100%');
                        Button.height(54);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(155:17)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        if (!this.isLoading) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Image.create({ "id": 0, "type": 30000, params: ['注册.png'], "bundleName": "com.example.myapplication", "moduleName": "entry" });
                                    Image.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(157:21)", "entry");
                                    Image.width(22);
                                    Image.height(22);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(163:19)", "entry");
                        Text.fontSize(17);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 登录链接
            Row.create();
            Row.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(183:11)", "entry");
            // 登录链接
            Row.justifyContent(FlexAlign.Center);
            // 登录链接
            Row.padding(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('已有账号？');
            Text.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(184:13)", "entry");
            Text.fontSize(15);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('立即登录');
            Text.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(189:13)", "entry");
            Text.fontSize(15);
    ...
    InputField(label: string, placeholder: string, type: InputType, value: string, onChange: (value: string) => void, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(217:5)", "entry");
            Column.width('100%');
            Column.margin({ bottom: 16 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(label);
            Text.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(218:7)", "entry");
            Text.fontSize(14);
            Text.fontColor('#666666');
            Text.fontWeight(FontWeight.Medium);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/components/common/RegisterPage.ets(225:7)", "entry");
            TextInput.width('100%');
            TextInput.height(50);
