...
class SettingsPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(41:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/pages/SettingsPage.ets(43:7)", "entry");
            Scroll.layoutWeight(1);
            Scroll.backgroundColor('#F5F7F9');
        }, Scroll);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(44:9)", "entry");
            Column.width('100%');
    ...
    private buildTopBar(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(64:5)", "entry");
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(65:7)", "entry");
            Row.width('100%');
            Row.height(56);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(66:9)", "entry");
            Row.width(44);
            Row.height(44);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('←');
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(67:11)", "entry");
            Text.fontSize(26);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('设置');
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(78:9)", "entry");
            Text.fontSize(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SettingsPage.ets(83:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('⚙️');
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(85:9)", "entry");
            Text.fontSize(20);
            Text.fontColor('#FFFFFF');
            Text.opacity(0.8);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 颜色过渡条
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(95:7)", "entry");
            // 颜色过渡条
            Column.width('100%');
            // 颜色过渡条
            Column.height(12);
    ...
    private buildBaseInfoSection(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(107:5)", "entry");
            Column.width('100%');
            Column.margin({ top: 16 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(108:7)", "entry");
            Row.width('100%');
            Row.padding({ left: 20, right: 20, top: 20, bottom: 12 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('基础信息');
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(109:9)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SettingsPage.ets(114:9)", "entry");
        }, Blank);
        Blank.pop();
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(119:7)", "entry");
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(120:9)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('位置');
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(121:11)", "entry");
            Text.fontSize(15);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SettingsPage.ets(125:11)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.locationName);
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(127:11)", "entry");
            Text.fontSize(15);
    ...
    private buildRelaySection(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(143:5)", "entry");
            Column.width('100%');
            Column.margin({ top: 16 });
        }, Column);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(147:11)", "entry");
                }, Column);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (index < this.relaySettings.length - 1) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Divider.create();
                                Divider.debugLine("entry/src/main/ets/pages/SettingsPage.ets(150:15)", "entry");
    ...
    private buildRelayRow(item: RelaySetting, order: number, parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(167:7)", "entry");
            Row.width('100%');
            Row.padding({ left: 20, right: 20, top: 16, bottom: 16 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`${order}.`);
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(168:9)", "entry");
            Text.fontSize(15);
            Text.fontColor('#333333');
            Text.margin({ right: 8 });
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/pages/SettingsPage.ets(173:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(182:9)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(item.isVisible ? '显示' : '隐藏');
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(183:11)", "entry");
            Text.fontSize(13);
            Text.fontColor(item.isVisible ? '#11C26D' : '#8A8F99');
            Text.margin({ right: 6 });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Toggle.create({ type: ToggleType.Switch, isOn: item.isVisible });
            Toggle.debugLine("entry/src/main/ets/pages/SettingsPage.ets(188:11)", "entry");
    ...
    private buildSensorSection(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(203:5)", "entry");
            Column.width('100%');
            Column.margin({ top: 16 });
        }, Column);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(205:7)", "entry");
            Column.width('100%');
            Column.backgroundColor('#FFFFFF');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(207:11)", "entry");
                }, Column);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (index < this.sensorSettings.length - 1) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Divider.create();
                                Divider.debugLine("entry/src/main/ets/pages/SettingsPage.ets(210:15)", "entry");
                                Divider.color('#F0F0F0');
                                Divider.width('100%');
                            }, Divider);
                        });
    ...
    private buildSensorCard(item: SensorSetting, order: number, parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(227:7)", "entry");
            Row.width('100%');
            Row.padding({ left: 20, right: 20, top: 16 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`${order}.`);
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(228:9)", "entry");
            Text.fontSize(15);
            Text.fontColor('#333333');
            Text.margin({ right: 8 });
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TextInput.create({ placeholder: item.placeholder, text: item.name });
            TextInput.debugLine("entry/src/main/ets/pages/SettingsPage.ets(233:9)", "entry");
            TextInput.layoutWeight(1);
            TextInput.height(44);
            TextInput.backgroundColor('#FFFFFF');
            TextInput.border({ width: 0 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(242:9)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(item.isVisible ? '显示' : '隐藏');
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(243:11)", "entry");
            Text.fontSize(13);
            Text.fontColor(item.isVisible ? '#11C26D' : '#8A8F99');
            Text.margin({ right: 6 });
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Toggle.create({ type: ToggleType.Switch, isOn: item.isVisible });
            Toggle.debugLine("entry/src/main/ets/pages/SettingsPage.ets(248:11)", "entry");
            Toggle.selectedColor('#11C26D');
            Toggle.switchPointColor('#FFFFFF');
            Toggle.onChange((isOn: boolean) => {
    ...
    private buildThresholdRow(item: SensorSetting, label: string, isMax: boolean, parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(266:5)", "entry");
            Row.width('100%');
            Row.padding({ left: 20, right: 20, top: 12, bottom: 12 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(267:7)", "entry");
            Column.layoutWeight(1);
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(label);
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(268:9)", "entry");
            Text.fontSize(13);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(273:9)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('清除');
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(274:11)", "entry");
            Text.fontSize(12);
            Text.fontColor('#11C26D');
            Text.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 8 });
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(285:7)", "entry");
        }, Row);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(290:9)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor('#333333');
            Text.width(48);
    ...
    private buildStepButton(symbol: string, onTap: () => void, parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(308:5)", "entry");
            Column.width(32);
            Column.height(32);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(symbol);
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(309:7)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor('#11C26D');
        }, Text);
    ...
    private buildSectionHeader(title: string, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(326:5)", "entry");
            Row.width('100%');
            Row.padding({ left: 20, right: 20, top: 20, bottom: 12 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(title);
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(327:7)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor('#11C26D');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SettingsPage.ets(332:7)", "entry");
        }, Blank);
        Blank.pop();
        Row.pop();
    }
    private buildSaveBar(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(341:5)", "entry");
            Column.width('100%');
            Column.backgroundColor('#FFFFFF');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/SettingsPage.ets(342:7)", "entry");
            Button.width('90%');
            Button.height(48);
            Button.fontSize(18);
