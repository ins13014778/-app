...
class EditProfile extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/EditProfile.ets(40:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 顶部导航栏
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/EditProfile.ets(42:7)", "entry");
            // 顶部导航栏
            Row.width('100%');
            // 顶部导航栏
            Row.height(56);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 取消按钮
            Text.create('取消');
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(44:9)", "entry");
            // 取消按钮
            Text.fontSize(16);
            // 取消按钮
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/EditProfile.ets(51:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('编辑资料');
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(53:9)", "entry");
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/EditProfile.ets(58:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 保存按钮
            Text.create('保存');
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(61:9)", "entry");
            // 保存按钮
            Text.fontSize(16);
            // 保存按钮
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/pages/EditProfile.ets(75:7)", "entry");
            Scroll.layoutWeight(1);
            Scroll.backgroundColor('#F5F5F5');
        }, Scroll);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/EditProfile.ets(76:9)", "entry");
            Column.width('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 头像选择区域
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/EditProfile.ets(78:11)", "entry");
            // 头像选择区域
            Column.width('100%');
            // 头像选择区域
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('头像');
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(79:13)", "entry");
            Text.fontSize(14);
            Text.fontColor('#666666');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 当前头像显示
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/EditProfile.ets(86:13)", "entry");
            // 当前头像显示
            Row.width('100%');
            // 当前头像显示
            Row.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(87:15)", "entry");
            Text.fontSize(48);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/EditProfile.ets(91:15)", "entry");
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('点击更换头像');
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(92:17)", "entry");
            Text.fontSize(14);
            Text.fontColor('#333333');
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(95:17)", "entry");
            Text.fontSize(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/EditProfile.ets(102:15)", "entry");
        }, Blank);
        Blank.pop();
        // 当前头像显示
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.showAvatarPicker) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Grid.create();
                        Grid.debugLine("entry/src/main/ets/pages/EditProfile.ets(114:15)", "entry");
                        ...
                        const forEachItemGenFunction = _item => {
                            const emoji = _item;
                            {
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ...
                                    GridItem.debugLine("entry/src/main/ets/pages/EditProfile.ets(116:19)", "entry");
                                };
                                const observedDeepRender = () => {
                                    this.observeComponentCreation2(itemCreation2, GridItem);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create(emoji);
                                        Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(117:21)", "entry");
                                        Text.fontSize(32);
                                        Text.padding(8);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 用户名（只读）
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/EditProfile.ets(148:11)", "entry");
            // 用户名（只读）
            Column.width('100%');
            // 用户名（只读）
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('用户名');
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(149:13)", "entry");
            Text.fontSize(14);
            Text.fontColor('#666666');
            Text.alignSelf(ItemAlign.Start);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/pages/EditProfile.ets(155:13)", "entry");
            TextInput.width('100%');
            TextInput.height(48);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('用户名不可修改');
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(162:13)", "entry");
            Text.fontSize(12);
            Text.fontColor('#999999');
            Text.margin({ top: 4 });
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 邮箱（只读）
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/EditProfile.ets(172:11)", "entry");
            // 邮箱（只读）
            Column.width('100%');
            // 邮箱（只读）
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('邮箱');
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(173:13)", "entry");
            Text.fontSize(14);
            Text.fontColor('#666666');
            Text.alignSelf(ItemAlign.Start);
            Text.margin({ bottom: 8 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/pages/EditProfile.ets(179:13)", "entry");
            TextInput.width('100%');
            TextInput.height(48);
            TextInput.backgroundColor('#F5F5F5');
            TextInput.borderRadius(8);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('邮箱不可修改');
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(186:13)", "entry");
            Text.fontSize(12);
            Text.fontColor('#999999');
            Text.margin({ top: 4 });
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 手机号
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/EditProfile.ets(196:11)", "entry");
            // 手机号
            Column.width('100%');
            // 手机号
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('手机号');
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(197:13)", "entry");
            Text.fontSize(14);
            Text.fontColor('#666666');
            Text.alignSelf(ItemAlign.Start);
            Text.margin({ bottom: 8 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/pages/EditProfile.ets(203:13)", "entry");
            TextInput.width('100%');
            TextInput.height(48);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 个人简介
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/EditProfile.ets(220:11)", "entry");
            // 个人简介
            Column.width('100%');
            // 个人简介
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('个人简介');
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(221:13)", "entry");
            Text.fontSize(14);
            Text.fontColor('#666666');
            Text.alignSelf(ItemAlign.Start);
            Text.margin({ bottom: 8 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextArea.debugLine("entry/src/main/ets/pages/EditProfile.ets(227:13)", "entry");
            TextArea.width('100%');
            TextArea.height(120);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(238:13)", "entry");
            Text.fontSize(12);
            Text.fontColor('#999999');
            ...
            if (this.errorMessage) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(250:13)", "entry");
                        Text.fontSize(14);
            ...
            if (this.successMessage) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/EditProfile.ets(261:13)", "entry");
                        Text.fontSize(14);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/EditProfile.ets(271:11)", "entry");
            // 保存按钮
            Button.width('90%');
            // 保存按钮
            Button.height(48);
